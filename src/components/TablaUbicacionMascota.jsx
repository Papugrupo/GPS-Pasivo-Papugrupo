...
            <tr>
              <th
                className="px-4 py-3 text-left text-sm font-semibold text-gray-700 cursor-pointer w-[28%]" // CAMBIO: w-1/2 eliminado, ahora w-[28%]
                onClick={toggleSort}
              >
                Fecha {sortAsc ? '↑' : '↓'}
              </th>
              <th className="px-4 py-3 text-left text-sm font-semibold text-gray-700 w-[32%]">Coordenadas</th> {/* CAMBIO: w-[32%] */}
              <th className="px-4 py-3 text-left text-sm font-semibold text-gray-700 w-[20%]">Mascota</th> {/* CAMBIO: w-[20%] */}
              <th className="px-4 py-3 text-left text-sm font-semibold text-gray-700 w-[20%]">Acciones</th> {/* CAMBIO: w-[20%] */}
            </tr>
          </thead>
        </table>
...
                  {/* CAMBIOS EN LOS TD: Ahora tienen los mismos anchos que los TH */}
